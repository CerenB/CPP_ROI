function matlabbatch = setBatchContrastFiles(varargin)
% insprired by function called: setBatchSubjectLevelResults
% unnecessary parts were omitted 
  %
  ...
  matlabbatch = setBatchContrastMask(matlabbatch, result);
